...
//                                    Toast.makeText(getContext(), productsModel.toString(), Toast.LENGTH_SHORT).show();
                            ...
                            final CollecAdapter adapter = new CollecAdapter(CollectionActivity.this, myRec);
                            rvCollection.setLayoutManager(new GridLayoutManager(CollectionActivity.this, 3));
